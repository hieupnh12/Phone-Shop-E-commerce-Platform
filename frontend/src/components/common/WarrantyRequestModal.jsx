...
const WarrantyRequestModal = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.appointmentDate) {
      const validation = validateAppointmentDate(formData.appointmentDate);
      if (!validation.valid) {
        setToast({
          type: "error",
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Mô tả càng chi tiết sẽ giúp chúng tôi xử lý yêu cầu của bạn nhanh
              hơn
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Chọn ngày và giờ bạn muốn đến cửa hàng (nếu có). Giờ làm việc:
              8:00 - 17:00. Không được chọn thời gian trong quá khứ.
            </p>
          </div>
          ...
          <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="text-sm text-blue-800">
              ...
              <ul className="list-disc list-inside space-y-1 text-blue-700">
                ...
                <li>
                  Nhân viên sẽ liên hệ với bạn để xác nhận và hướng dẫn các bước
                  tiếp theo
                </li>
